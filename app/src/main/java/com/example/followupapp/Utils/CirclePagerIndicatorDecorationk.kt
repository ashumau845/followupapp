...
class CirclePagerIndicatorDecorationk : RecyclerView.ItemDecoration() {

    private val colorInactive = Color.parseColor("#727272")
    private val colorActive = Color.parseColor("#F44336")
